...
I got inspiration for this from the excellent [http://petermckeever.com/2019/04/creating-squad-age-profiles/](article) by @petermckeever.
...
We can see the graph looks a bit easy with some overlapping names. We can use the `check_overlap` property to help deal with this, but I found it removed several key players from the graph. 
